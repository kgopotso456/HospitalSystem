...
public class HospitalSystem {
    public static void main(String[] args) {
        ...
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            do {
                System.out.println("==============================================");
                System.out.println("           Dikolong HOSPITAL SYSTEM           ");
                System.out.println("==============================================");
                ...
                switch (choice) {
                    ...
                    case 2 -> {
                        ...
                        if (pFound != null) {
                            ...
                            if (pFound instanceof Inpatient inpatient) {
                                String assignedBed = inpatient.getBedNumber();
                    ...
                    case 3 -> {
                        ...
                        do {
                            ...
                            switch (updateChoice) {
                                ...
                                case 6 -> {
                                    if (pUpdate instanceof Inpatient inpatient) {
                                        System.out.print("Enter new Ward Number: ");
                                        inpatient.setWardNumber(scanner.nextLine());
                                        System.out.println("Updated successfully.");
                                    }
                                }
                        ...
                        if (patients.isEmpty()) {
                            ...
                            for (Patient p : patients) {
                                ...
                                if (p instanceof Inpatient inpatient) {
                                    String b = inpatient.getBedNumber();
                    ...
                    default -> System.out.println("Invalid option. Please choose between 0 and 13.");
                }
                System.out.println();
            } while (choice != 0);
        }
